...
const ANGULAR_VERSION = '9.0.2';
const ANGULAR_CDK_VERSION = '9.1.0';
const ANGULAR_ANIMATIONS_VERSION = '9.0.2';
const PRIMENG_VERSION = '9.0.0';
const PRIMEICONS_VERSION = '2.0.0';
const PRIMEFLEX_VERSION = '1.0.0';
const PRIMENG_EXTENSIONS_VERSION = '1.0.0';
const CHARTJS_VERSION = '2.7.3';
const QUILL_VERSION = '1.3.7';
const FONTAWESOME_VERSION = '4.7.0';
const FULLCALENDAR_CORE_VERSION = '4.1.0';
const FULLCALENDAR_DAYGRID_VERSION = '4.1.0';
const FULLCALENDAR_INTERACTION_VERSION = '4.1.0';
const FULLCALENDAR_TIMEGRID_VERSION = '4.1.0';
...
module.exports = {
    ...
    FULLCALENDAR_CORE_VERSION,
    FULLCALENDAR_DAYGRID_VERSION,
    FULLCALENDAR_INTERACTION_VERSION,
    FULLCALENDAR_TIMEGRID_VERSION,
    QUILL_VERSION,
    THEME_OPTIONS,
    codes,
    primengTranslation,
