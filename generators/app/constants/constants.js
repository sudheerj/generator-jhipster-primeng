...
const FULLCALENDAR_CORE_VERSION = '4.0.2';
const FULLCALENDAR_DAYGRID_VERSION = '4.0.1';
const FULLCALENDAR_INTERACTION_VERSION = '4.0.2';
const FULLCALENDAR_TIMEGRID_VERSION = '4.0.1';
